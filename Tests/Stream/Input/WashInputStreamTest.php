...
class WashInputStreamTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return [
            ["68656C6C6F\n", 0, 10, "68656C6C6F", 10, 0, 0],
            ["68656C6C6F\r", 0, 10, "68656C6C6F", 10, 0, 0],
            ["68656C6C6F\t", 0, 10, "68656C6C6F", 10, 0, 0],
            ["68656C6C6F ", 0, 10, "68656C6C6F", 10, 0, 0],
            ["6865\n6C6C6F\r", 0, 10, "68656C6C6F", 10, 0, 0],
            ["6865\r6C6C6F\t", 0, 10, "68656C6C6F", 10, 0, 0],
            ["6865\t6C6C6F ", 0, 10, "68656C6C6F", 10, 0, 0],
            ["6865 6C6C6F\n", 0, 10, "68656C6C6F", 10, 0, 0],
            ["6865\t6C6C6F\n", 2, 8, "656C6C6F", 8, 2, 0],
            ["6865\t6C6C6F\n", 4, 6, "6C6C6F", 6, 4, 0],
            ["6865\t6C6C6F\n", 5, 5, "C6C6F", 5, 5, 0],
